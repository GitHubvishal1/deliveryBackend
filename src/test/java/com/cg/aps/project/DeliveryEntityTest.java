 ...
 *
 */
@SpringBootTest // Creates the ApplicationContext that will be utilized in our tests by searching upwards looking for @SpringBootConfigurations.

class DeliveryEntityTest {

	@MockBean // Used to add mocks to a spring to verify behaviours of methods
	DeliveryDao dao;
	 ...
	 */
	@Test // Junit run as a test case to check Add delivery method
